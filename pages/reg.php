...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if ($stmt->num_rows > 0) {
            ...
            $stmt = $db->prepare("INSERT INTO users (login, password, full_name, birth_date, photo) VALUES (?, ?, ?, ?, ?)");
            $stmt->bind_param('sssss', $login, $hashed_password, $full_name, $birth_date, $photo);
    ...
    <div class="auth-card">
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="full_name" name="full_name" class="form-control" placeholder="Введите ваше имя" value="<?= htmlspecialchars($full_name ?? '') ?>">
            </div>
            <div class="form-group">
